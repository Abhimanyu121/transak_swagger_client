...
class PartnerApi {
  ...
  PartnerApi([TransakClient apiClient])
      : apiClient = apiClient ?? defaultApiClient;

  /// Get the order details using the partner API secret
  ///
  ///
  Future<InlineResponse2006> partnerGetOrder(
      String partnerAPISecret, String orderId) async {
    ...
    String path = "/partners/order/{orderId}"
  ...
  ///
  ///
  Future<InlineResponse2006> partnerGetOrders(String partnerAPISecret,
      {double limit, double skip}) async {
    Object postBody = null;
    ...
    if (skip != null) {
      queryParams
          .addAll(_convertParametersForCollectionFormat("", "skip", skip));
    }
  ...
  Future<InlineResponse2006> partnerGetPartnerInfo(String partnerApiKey) async {
    ...
    // create path and map variables
    String path = "/partners/{partnerApiKey}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "partnerApiKey" + "}", partnerApiKey.toString());
  ...
  ///
  ///
  Future<InlineResponse2006> partnerGetPastWebhooks(String partnerAPISecret,
      {String orderID, String eventID}) async {
    Object postBody = null;
    ...
    if (eventID != null) {
      queryParams.addAll(
          _convertParametersForCollectionFormat("", "eventID", eventID));
    }
  ...
  ///
  ///
  Future<InlineResponse2006> partnerUpdateWebhookURL(
      String partnerAPISecret, String webhookURL) async {
    Object postBody = null;
